...
public class SaveLocationHistory {
	 ...
	 * @param main_activity MainActivity_CameraOpen.
	 * @param pref_base String to use for shared preferences_sound_recorder.
	 * @param folder_name The current save folder.
	 */
	SaveLocationHistory(MainActivity_CameraOpen main_activity, String pref_base, String folder_name) {
		if( MyDebug.LOG )
		...
		updateFolderHistory(folder_name, false); // update_icon can be false, as updateGalleryIcon() is called later in MainActivity_CameraOpen.onResume()
	 ...
	 * MainActivity_CameraOpen.updateGalleryIcon().
	 */
