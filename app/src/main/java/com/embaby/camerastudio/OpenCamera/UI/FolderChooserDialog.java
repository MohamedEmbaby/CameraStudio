...
import com.embaby.camerastudio.OpenCamera.StorageUtils;
...
public class FolderChooserDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		String folder_name = sharedPreferences.getString(PreferenceKeys.getSaveLocationPreferenceKey(), "Camera Studio");
		if( MyDebug.LOG )
