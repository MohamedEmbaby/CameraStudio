 ...
 *  communication to be via the bundle (since this replaced the MainActivity_CameraOpen,
...
public class MyPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addPreferencesFromResource(R.xml.preferences_open_camera);
...
//						MainActivity_CameraOpen main_activity = (MainActivity_CameraOpen)MyPreferenceFragment.this.getActivity();
...
//            	        /*Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(MainActivity_CameraOpen.getDonateMarketLink()));
//            	        try {
...
//                	        browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(MainActivity_CameraOpen.getDonateLink()));
//            	        	startActivity(browserIntent);
//            			}*/
//						Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(MainActivity_CameraOpen.getDonateLink()));
//						startActivity(browserIntent);
//						return false;
//					}
//					return false;
...
//		}
			...
			pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
				...
				public boolean onPreferenceClick(Preference arg0) {
					if( pref.getKey().equals("preference_about") ) {
						...
						about_string.append("\nCamera Studio v" + version);
						about_string.append("\n" + getActivity().getResources().getString(R.string.preference_about_licence));
						about_string.append("\n" + getActivity().getResources().getString(R.string.preference_about_licence_2));
						about_string.append("\nCurrent camera ID: ");
						...
						String save_location = sharedPreferences.getString(PreferenceKeys.getSaveLocationPreferenceKey(), "Camera Studio");
						about_string.append("\nSave Location: ");
						...
						alertDialog.setNegativeButton(R.string.about_copy_to_clipboard, new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								...
								ClipData clip = ClipData.newPlainText("Camera Studio About", about_string);
	...
	/* So that manual changes to the checkbox/switch preferences_sound_recorder, while the preferences_sound_recorder are showing, show up;
	 * in particular, needed for preference_using_saf, when the user cancels the SAF dialog (see
	 * MainActivity_CameraOpen.onActivityResult).
	 */
